...
public class GitUpdateListenerTest {
  ...
  public void setupRepo() throws IOException {
    gitRepoMetricsCache =
            new GitRepoMetricsCache(
                    ...
                    Utils.getRpoConfig(Collections.singletonList(testProject)));
    ...
    gitRepoUpdateListener =
        new GitRepoUpdateListener(repoManager, mockedExecutorService, updateGitMetricsTaskFactory, gitRepoMetricsCache);
  ...
  @Test
  public void shouldNotUpdateMetricsIfProjectIsNotEnabled() {
    doNothing().when(mockedExecutorService).execute(valueCapture.capture());
