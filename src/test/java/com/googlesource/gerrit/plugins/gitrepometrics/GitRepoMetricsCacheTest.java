...
public class GitRepoMetricsCacheTest {
  ...
  public void shouldRegisterMetricsOnlyOnce() {
    ...
    gitRepoMetricsCache =
        new GitRepoMetricsCache(
            ds,
            fakeMetricMaker,
            new MetricsTracker("git-repo-metrics", metricRegistry),
  ...
  private static MetricsTracker newMetricsTracker() {
    return new MetricsTracker("git-repo-metrics", new MetricRegistry());
  }
}
