...
public class GitRepositoryStatisticsTest {
  ...
  public void testShouldReportZeroObjectsForInitializedRepo() {
    // when
    GitRepositoryStatistics.RepositoryStatistics result =
        GitRepositoryStatistics.collectFor(repository.getRepository());

    // then
    assertThat(result.numberOfPackFilesAfterBitmap).isEqualTo(0L);
  }
  ...
  public void testShouldReportAllPackFilesWhenNoGcWasPerformed() throws Exception {
    ...
    // then
    assertThat(result.numberOfPackFilesAfterBitmap).isGreaterThan(0L);
    assertThat(result.numberOfPackFilesAfterBitmap)
        .isEqualTo(repository.getRepository().getObjectDatabase().getPacks().size());
  }
  ...
  public void testShouldReportNewObjectsAfterGcWhenRepositoryProgresses() throws Exception {
    ...
    // then
    assertThat(result.numberOfPackFilesAfterBitmap).isEqualTo(1L);
  }
