...
/** This interface is meant to be implemented by generic metrics collectors. * */
public interface GenericMetricsCollector {
   ...
   */
  void collect(Consumer<HashMap<GitRepoMetric, Long>> populateMetrics);
