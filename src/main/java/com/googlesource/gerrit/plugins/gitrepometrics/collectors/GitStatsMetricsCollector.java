...
public class GitStatsMetricsCollector implements MetricsCollector {
  ...
  public HashMap<String, Long> collect(FileRepository repository, Project.NameKey projectNameKey) {
    ...
    try {
      ...
      putMetric(projectNameKey, metrics, numberOfPackedObjects, statistics.numberOfPackedObjects);
      putMetric(projectNameKey, metrics, numberOfPackFiles, statistics.numberOfPackFiles);
      putMetric(projectNameKey, metrics, numberOfLooseObjects, statistics.numberOfLooseObjects);
      putMetric(projectNameKey, metrics, numberOfLooseRefs, statistics.numberOfLooseRefs);
      putMetric(projectNameKey, metrics, numberOfPackedRefs, statistics.numberOfPackedRefs);
      putMetric(projectNameKey, metrics, sizeOfLooseObjects, statistics.sizeOfLooseObjects);
      putMetric(projectNameKey, metrics, sizeOfPackedObjects, statistics.sizeOfPackedObjects);
      putMetric(projectNameKey, metrics, numberOfBitmaps, statistics.numberOfBitmaps);
  ...
  private void putMetric(
      ...
      String metricName,
      long value) {
    metrics.put(GitRepoMetricsCache.getMetricName(metricName, projectNameKey.get()), value);
  }
