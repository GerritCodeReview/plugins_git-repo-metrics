...
public interface MetricsCollector {
   ...
   *
   * @param projectNameKey {@link Project.NameKey} to collect metrics for
   ...
   */
  HashMap<String, Long> collect(FileRepository repository, Project.NameKey projectNameKey);
  ...
  default void putMetric(
      ...
      String metricName,
      long value) {
    metrics.put(getMetricName(metricName, projectNameKey.get()), value);
  }
}
